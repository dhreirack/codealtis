...
_illegal = ["Pillage_1", "Pillage_2", "Pillage_3","Pillage_4", "Pillage_5", "Pillage_6","Pillage_7", "Pillage_8", "Pillage_9","Pillage_10", "Pillage_11", "Pillage_12","cocaine processing", "heroin_1", "heroin_p", "cocaine_1","weed_1", "Weed_p_1"];
// Si gendarme on fait disparaitre les marqueurs du tableau => _illegal
